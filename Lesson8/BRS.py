...
def main():
    ...
    # Добавляем вызов функции для отображения информации по одному студенту
    display_student_info(student_scores)
...
def display_student_info(student_scores):
    student_name = input('Введите имя студента для отображения информации: ')

    if student_name in student_scores:
        student_data = student_scores[student_name]

        print(f"\nИнформация по студенту {student_name}:")
        print(f"Рейтинг промежуточной аттестации: {student_data['Рейтинг промежуточной аттестации']}")
        print(f"Рейтинг текущего контроля: {student_data['Рейтинг текущего контроля']}")
        print(f"Рейтинг по дисциплине: {student_data['Рейтинг по дисциплине']}")
        print(f"Оценка за дисциплину: {student_data['Оценка за дисциплину']}")
    else:
